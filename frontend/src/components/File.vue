<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="FileNm" v-model="value.fileNm" :editMode="editMode"/>
            <Boolean label="InexYn" v-model="value.inexYn" :editMode="editMode"/>
            <Boolean label="UploadYn" v-model="value.uploadYn" :editMode="editMode"/>
